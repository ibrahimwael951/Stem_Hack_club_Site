  ...
  return (
    <section className="min-h-screen w-full ">
      ...
      {Track_Category.description ? (
          ...
          <div className="my-10 flex flex-wrap justify-center gap-4 px-5">
            {filteredLessons.length > 0 ? (
              ...
              <div className="flex flex-col md:flex-row  justify-evenly items-center w-full">
                <h1 className="text-center md:text-start">No Lessons found</h1>
                <Image
                  className=" w-52"
                  alt="Image"
        ...
        <div className="h-screen w-full flex px-5 flex-col md:flex-row justify-center items-center">
      <div className="flex flex-col justify-center items-center lg:items-start">
      <h1 className="7xl text-center lg:text-start  ">
           We Still work on this category
         </h1>
         <p className="text-center lg:text-start">Stay tuned for more updates</p>
         <Link 
