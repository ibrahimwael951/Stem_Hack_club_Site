...
const DonationContent = () => {
  const Statistics = [
    ...
    { icon: <GoProjectRoadmap />, title: "Students Projects", value: 380 },
    { icon: <IoMdDoneAll />, title: "Sessions Delivered", value: 235 },
  ];
    ...
    <section className="px-5 lg:px-20 py-20 h-fit flex flex-col gap-20 justify-evenly">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className=" w-full lg:w-2/3  ">
          ...
          <Button title="Donate Now" href="https://hcb.hackclub.com/donations/start/stem-egypt-hack-club"/>
          </div>
        </div>
        <Image
