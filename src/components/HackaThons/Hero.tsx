    ...
    <>
      <div className="min-h-screen  ">
        <div
          ...
          style={{
            backgroundImage: `url(/Hackathons/CounterSpell/hero/bg5.png)`,
          }}
        >
          <HeroScroll />
        </div>
      ...
      <>
          ...
          >
            ...
            <div className="flex items-center justify-center text-center">
              <div className="z-50 absolute top-[43%] lg:top-[47%] text-[60%] sm:text-[80%] md:text-[100%] lg:text-[140%] tracking-wide">
                <p className="dark:text-[#CFD8ED] text-[#CFD8ED] retro">
                STEM High School for Boys - 6th of October
                </p>
                <p className="dark:text-pink-500 retro text-[80%] sm:text-[90%] lg:text-[90%] mt-2">
                November 23, 2024
                </p>
              </div>
            </div>
        ...
        <div className="translate-y-[35vw] md:translate-y-[200px] translate-x-[50vw] 2xl:translate-x-[120vw] scale-[300%] md:scale-[250%] 2xl:scale-[350%]">
          <img
            ...
            src="/Hackathons/CounterSpell/hero/bg1.png"
            alt=""
          />
          <img
            ...
            src="/Hackathons/CounterSpell/hero/bg2.png"
            alt=""
          />
          <img
            ...
            src="/Hackathons/CounterSpell/hero/bg3.png"
            alt=""
          />
          <img
            ...
            src="/Hackathons/CounterSpell/hero/bg4.png"
            alt=""
          />
        </div>
      </>
