    ...
    <section className="px-5 lg:px-20 py-20 h-fit flex flex-col gap-20 justify-evenly">
      <div>
        ...
        <p className="ml-4 ">
          ...
          technology and science. Through workshops, hackathons, and mentorship,
          we empower students to explore STEM fields and solve real-world
          problems. But we cant do it without your support.
        </p>
      </div>
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className=" w-full lg:w-2/3  ">
          ...
          <a href="https://hcb.hackclub.com/donations/start/stem-egypt-hack-club" className="m-5   p-4 border border-red-600 hover:text-white hover:bg-red-600 rounded-xl">Donate Now</a>
          </div>
        </div>
        <Image
